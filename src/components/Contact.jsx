...
export default function Contact() {
  ...
  return (
      ...
      <div style={bg} className="w-full flex flex-col items-center justify-center " id="contact">
        <p style={textOrange} className='my-4 open-sans text-orange-500 text-2xl md:text-3xl tracking-wider text-center'>CONTACT</p>
        ...
        <form action="" method="">
          ...
          <div className="flex flex-col items-center justify-center space-y-5 mt-5">
            ...
            <div className="flex flex-col items-center justify-center space-y-4">
              ...
              <textarea style={bg1} className="open-sans hover:outline-none hover:ring-2 hover:ring-gray-300 hover:border-transparent w-3/4 lg:w-full rounded peer block h-48 lg:h-60 border-0 bg-transparent py-4 lg:py-5 px-5 leading-6 lg:leading-7 outline-none transition-all duration-200 ease-linear placeholder:open-sans focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none text-white resize-none" name="" id="" cols="90" rows="10" placeholder="Message"></textarea>

            </div>

            <button style={bgbuttn} className="send-button space-grotesk w-32 lg:w-40 h-14 lg:h-16 bg-orange-500 text-white font-bold text-lg lg:text-2xl tracking-wider">SEND</button>
